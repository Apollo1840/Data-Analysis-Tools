...
epochs = 33 # Turn epochs to 30 to get 0.9967 accuracy
batch_size = 86
...
print('training time: {} min'.format(time()-t0/60))
...
submission.to_csv(DATA_PATH+"cnn_mnist_ep{}.csv".format(epochs),index=False)
